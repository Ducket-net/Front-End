...
export class BaseFurniture implements IFurnitureEventHandlers, IEventGroup {
  ...
  private _furniSize: number | undefined;
  ...
  private _updateFurnitureSprites(loadFurniResult: LoadFurniResult) {
    ...
    this._updateDirection(); //Console Logs Out
    

    this.visualization.updateAnimation(this.animation); //Console Logs Out
...
this.dependencies.furnitureLoader.loadFurni(this._type, this.furniSize).then((result) => {
