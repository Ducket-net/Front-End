<template>
  <button
    class="overflow-hidden z-0 relative top-0 rounded-lg w-[50px] furni-box h-[50px] border border-black bottom-1 bg-gray-200 flex-shrink-0 flex items-center justify-center p-1"
    :class="buttonClass"
    @click="$emit('button-click')"
  >
    <slot></slot>
    <!-- <video
      class="card-video bg-white"
      muted
      autoplay
      playsinline
