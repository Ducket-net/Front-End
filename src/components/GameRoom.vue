...
<template>
    <div class="max-w-md mx-auto" ref="container">
        <h2>Room {{ roomId }}</h2>
        <div
            ref="canvasContainer"
            id="canvasContainer"
            ...
            tabindex="0"
        >
            <canvas ref="canvas" class="outline-0"></canvas>
            <div>
        ...
        <div class="max-w-sm space-y-4">
            <form
                ...
                class="space-y-2 grid grid-cols-2 gap-1"
            >
                <div class="">
                ...
                <div class="">
                    <label class="block text-gray-700">Animation</label>
                    <input
            ...
            switch (event.key) {
                ...
                case ",":
                    this.selectedItem.direction =
                        (this.selectedItem.direction + 1) % 8;
                    break;
            }
        },
    },
